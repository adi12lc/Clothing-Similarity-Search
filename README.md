...
```
Note : If you encounter a memory error or any other error when executing the above command, please create a service on Cloud Run console by selecting the image you have previously pushed.
